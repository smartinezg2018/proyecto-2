...
import { ASSETS, formatCompactCurrency as fmtM } from '../fixtures.js';
...
export function ModuleInventario() {
  ...
  const filtered = ASSETS.filter((a) => filter === 'Todos' || a.status === filter).filter(
    (a) =>
      !search ||
  ...
  return (
    <div>
      <SectionHead
        ...
        subtitle="Registro y gesti�n de activos del conjunto residencial"
        action={
          <Btn>
