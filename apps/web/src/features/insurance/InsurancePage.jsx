...
export function ModuleSeguros() {
  ...
  return (
    <div>
      <SectionHead
        title="Seguros y P�lizas"
        subtitle="Gesti�n de p�lizas de seguros y seguimiento a siniestralidad"
        action={
          <Btn>
            <Plus size={14} /> Registrar P�liza
          </Btn>
        }
      />
        ...
        <div className="bg-red-50 border border-red-200 rounded-xl p-4 mb-6">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-sm font-bold text-red-800">
              Vencimientos Urgentes � Acci�n Requerida
            </span>
          </div>
            ...
            {expiring.map((p) => (
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm font-bold text-red-600">{p.daysLeft} d�as</span>
      ...
      <div className="flex gap-0 mb-4 bg-slate-100 rounded-lg p-1 w-fit">
        {[
          { key: 'polizas', label: 'P�lizas Registradas' },
            ...
            <tbody>
              <tr className="border-b border-slate-50 hover:bg-slate-50 transition-colors">
                ...
                <td className="px-4 py-3 text-sm text-slate-700">
                  Da�o el�ctrico planta de emergencia
                </td>
                <td className="px-4 py-3">
                  <Badge label="Activo" />
                </td>
              ...
              <tr className="border-b border-slate-50 hover:bg-slate-50 transition-colors">
                ...
                <td className="px-4 py-3 text-sm text-slate-700">Da�o cubierta por granizo</td>
                <td className="px-4 py-3">
                  <Badge label="En mora" />
                </td>
